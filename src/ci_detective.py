...
def render_markdown_report(job_name:str,diagnosis:Diagnosis)->str:
    ...
    if any("Likely regression candidate" in x for x in combined): lines += ["", "### Assessment","**Likely regression detected:** No. The changed-file match is only a correlation signal and is not sufficient to establish causation."]
